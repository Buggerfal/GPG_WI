        ...
        onResize: function(e, t) {
            ...
            if (manager.updateOrientation(o, s), i || o !== manager.oldWinWidth || s !== manager.oldWinHeight) {
                ...
                if (1 === manager.scaleMethodIndex) {
                    game.scale.setGameSize(g, u), this.scaleFactor = l, game.mainGroup.scale.set(l);
...
var UiManager = (function () {
    ...
    var manager = {
        init: function () {
            ...
            this.install_button_label.fontSize = this.install_button.height * GLOBAL_SCALE * 1.5
