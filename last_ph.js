        ...
        onResize: function(e, t) {
            ...
            if (manager.updateOrientation(o, s), i || o !== manager.oldWinWidth || s !== manager.oldWinHeight) {
                ...
                if (1 === manager.scaleMethodIndex) {
                    game.scale.setGameSize(g, u), this.scaleFactor = l, game.mainGroup.scale.set(l), game.mainWorldGroup.scale.set(l);
                ...
                if (game.world.height / game.world.width < 1.85 && !config.isLandscape && GPP_OPTION.VARIATION_MECHANIC == "B") {
...
var UiManager = (function () {
    ...
    var manager = {
        init: function () {
            ...
            this.install_button_label.fontSize = this.install_button.height * GLOBAL_SCALE * 3
            ...
            if (GPP_OPTION.VARIATION_MECHANIC == "B") text = "0$"
        ...
        onResize: function () {
            ...
            if (GPP_OPTION.VARIATION_MECHANIC == 'B') this.makeFooter()
    ...
    var manager = {
        ...
        loadAssets: function () {
            ...
            for (var i = 0; i < 3; i++) {
                ...
                if ((GPP_OPTION.VARIATION_WORLD == "B" || VARIATION_TEMP == "B") && GPP_OPTION.VARIATION_MECHANIC != "B") {
...
var Boot = (function () {
    ...
    state.prototype = {
        init: function () {
            ...
            console.log("Mechanic variation - " + GPP_OPTION.VARIATION_MECHANIC)
            ...
            for (var i = 0; i < ANIMALS.length; i++) {
                ...
                if (canCatch) {
                    ...
                    if (animal.y < catchPoint && distance < farmDistance) {
                        ...
                        if (GPP_OPTION.VARIATION_MECHANIC != "B") catchCasual()
                        else if (GPP_OPTION.VARIATION_MECHANIC == "B") catchIdle()
                    }
